...
///Cargo///
/datum/job/qm/New()
	access = list(ACCESS_CARGO_BOT, ACCESS_CARGO, ACCESS_HEADS_VAULT, ACCESS_HEADS, ACCESS_KEYCARD_AUTH, ACCESS_QM,
		ACCESS_RC_ANNOUNCE, ACCESS_SEC_DOORS, ACCESS_WEAPONS, ACCESS_MAILSORTING, ACCESS_MINING, ACCESS_MINING_STATION,
		ACCESS_MINERAL_STOREROOM, ACCESS_CARGO_BAY, ACCESS_SUPPLY_SHUTTLE, ACCESS_MAINT_TUNNELS, ACCESS_SMITH,
		ACCESS_EXPEDITION, ACCESS_EVA, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_TELEPORTER);
	return ..()

/datum/job/cargo_tech/New()
	access = list(ACCESS_MAILSORTING, ACCESS_MINING, ACCESS_MINING_STATION,
		ACCESS_MINERAL_STOREROOM, ACCESS_CARGO, ACCESS_CARGO_BAY, ACCESS_SUPPLY_SHUTTLE, ACCESS_MAINT_TUNNELS, ACCESS_SMITH,
		ACCESS_EXPEDITION, ACCESS_EVA, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_TELEPORTER)
	return ..()
